...
if(window.innerWidth < 450){           // Checks whether the user agent is mobile or not with help of Device width
    ScrollReveal().reveal('.product-reveal', { distance: '1500%',origin: 'top', opacity: 0, delay: 200, duration: 1000});
}else{
    ScrollReveal().reveal('.product-reveal', { distance: '1500%',origin: 'left', opacity: 0, duration: 1000});
}
